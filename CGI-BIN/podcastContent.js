const podcastImageBase =
    typeof window !== 'undefined'
        ? new URL('Images/', window.location.origin).href
        : '/Images/';
...
<div class="podcast-section">
    <div class="podcast-item">
        <img src="${podcastImageBase}AllInPodcastCover.jpg" alt="All In Podcast Cover" class="podcast-cover">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}BrokeGirlSocietyPodcastCover.jpg" alt="Broke Girl Society Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}AfterGamblingPodcastCover.jpg" alt="After Gambling Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}fallInPodcastCover.jpg" alt="Fall In Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}foldEmPodcastCover.jpg" alt="Fold Em Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}fantasyOrRealityPodcastCover.jpg" alt="Fantasy or Reality Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}helloCraigPodcastCover.jpg" alt="Hello, My Name is Craig Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}allBetsOffPodcastCover.jpg" alt="All Bets Are Off Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}invisibleAddictionPodcastCover.jpg" alt="The Invisible Addiction Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}hiddenAddictionPodcastCover.jpg" alt="The Hidden Addiction Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}problemGamblingPodcastCover.jpg" alt="The Problem Gambling Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}321PodcastCover.jpg" alt="3-21 NoKiddin' Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}voicesPodcastCover.jpg" alt="Voices Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="${podcastImageBase}ambitiousAddictsPodcastCover.jpg" alt="Ambitious Addicts Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
