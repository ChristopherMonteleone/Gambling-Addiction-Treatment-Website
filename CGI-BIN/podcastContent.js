...
<div class="podcast-section">
    <div class="podcast-item">
        <img src="Images/AllInPodcastCover.jpg" alt="All In Podcast Cover" class="podcast-cover">
    ...
    <div class="podcast-item">
        <img src="Images/BrokeGirlSocietyPodcastCover.jpg" alt="Broke Girl Society Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/AfterGamblingPodcastCover.jpg" alt="After Gambling Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/fallInPodcastCover.jpg" alt="Fall In Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/foldEmPodcastCover.jpg" alt="Fold Em Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/fantasyOrRealityPodcastCover.jpg" alt="Fantasy or Reality Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/helloCraigPodcastCover.jpg" alt="Hello, My Name is Craig Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/allBetsOffPodcastCover.jpg" alt="All Bets Are Off Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/invisibleAddictionPodcastCover.jpg" alt="The Invisible Addiction Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/hiddenAddictionPodcastCover.jpg" alt="The Hidden Addiction Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/problemGamblingPodcastCover.jpg" alt="The Problem Gambling Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/321PodcastCover.jpg" alt="3-21 NoKiddin' Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/voicesPodcastCover.jpg" alt="Voices Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
    ...
    <div class="podcast-item">
        <img src="Images/ambitiousAddictsPodcastCover.jpg" alt="Ambitious Addicts Podcast Cover" class="podcast-cover">
        <div class="podcast-description">
